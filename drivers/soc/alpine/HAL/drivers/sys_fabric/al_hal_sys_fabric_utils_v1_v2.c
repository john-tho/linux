...
#define NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_LEVEL_CPU_PORESET \
		(0x1 << NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_LEVEL_SHIFT)
...
{
	struct al_nb_regs_v1_v2 __iomem *nb_regs =
		(struct al_nb_regs_v1_v2 __iomem *)nb_regs_base;

	al_assert(handle);

	handle->ver = (al_reg_read32(&nb_regs->nb_version.version) &
		NB_V1_V2_NB_VERSION_VERSION_RELEASE_NUM_MAJOR_MASK) >>
		NB_V1_V2_NB_VERSION_VERSION_RELEASE_NUM_MAJOR_SHIFT;
	...
	unsigned int			idx)
{
	...
	nb_regs = (struct al_nb_regs_v1_v2 __iomem *)handle->nb_regs_base;
...
UTILS_STATIC void _al_sys_fabric_int_local_unmask(
	...
	unsigned int			mask)
{
	struct al_nb_regs_v1_v2 __iomem *nb_regs = (struct al_nb_regs_v1_v2 __iomem *)handle->nb_regs_base;
	...
	struct al_sys_fabric_sb_pos_error_info	*pos_info)
{
	...
	if (handle->ver == NB_NB_VERSION_VERSION_RELEASE_NUM_MAJOR_VAL_ALPINE_V2) {
		...
		for (i = 0; i < 1000; i++) {
			...
			if (!(nb_int_cause & NB_V1_V2_GLOBAL_NB_INT_CAUSE_SB_POS_ERR))
				break;

			al_reg_read32(&nb_regs->global.sb_pos_error_log_1);
			al_sys_fabric_int_clear(handle, ~NB_V1_V2_GLOBAL_NB_INT_CAUSE_SB_POS_ERR);
		}
	...
	pos_info->valid = (error_log_1 & NB_V1_V2_GLOBAL_SB_POS_ERROR_LOG_1_VALID) ? AL_TRUE : AL_FALSE;
	...
	al_bool					concat_reg_addr)
{
	...
	nb_regs = (struct al_nb_regs_v1_v2 __iomem *)handle->fabric_handle->nb_regs_base;
	...
	unsigned int				*msg)
{
	...
	*msg_valid = !!(val & NB_V1_V2_CPUN_CONFIG_STATUS_CPU_MSG_IN_VALID);
	*msg = (val & NB_V1_V2_CPUN_CONFIG_STATUS_CPU_MSG_IN_DATA_MASK) >>
		NB_V1_V2_CPUN_CONFIG_STATUS_CPU_MSG_IN_DATA_SHIFT;
}
...
{
	struct al_nb_regs_v1_v2 __iomem *nb_regs = (struct al_nb_regs_v1_v2 __iomem *)handle->nb_regs_base;
	struct al_nb_semaphores_v1_v2 *regs = &nb_regs->semaphores[id];
	uint32_t val;
	...
	const struct al_sys_fabric_cluster_handle	*handle)
{
	...
	al_reg_write32(
		...
		(3 << NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_LEVEL_SHIFT) |
		NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_SWRESET_REQ);
}
	...
	unsigned int				core)
{
	...
	al_reg_write32(
		&nb_regs->global.cpus_software_reset,
		(1 << (NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_CORES_SHIFT + core)) |
		NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_SWRESET_REQ);
}
	...
	unsigned int				core)
{
	...
	al_reg_write32(
		&nb_regs->global.cpus_software_reset,
		(1 << (NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_CORES_SHIFT + core)) |
		NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_LEVEL_CPU_PORESET |
		NB_V1_V2_GLOBAL_CPUS_SOFTWARE_RESET_SWRESET_REQ);
}
	...
	uint32_t				entry_low)
{
	...
	al_reg_write32(&nb_regs->cpun_config_status[core].config_aarch64,
		NB_V1_V2_CPUN_CONFIG_STATUS_CONFIG_AARCH64_AA64_NAA32);
}
		...
		enum al_sys_fabric_wr_split_mode	mode)
{
	...
	if (handle->ver == NB_NB_VERSION_VERSION_RELEASE_NUM_MAJOR_VAL_ALPINE_V2) {
		struct al_nb_regs_v1_v2 __iomem *nb_regs =
			(struct al_nb_regs_v1_v2 __iomem *)handle->nb_regs_base;
		...
		if (mode == SYS_FABRIC_WR_SPLIT_MODE_ALPINE_V1) {
			...
			al_reg_write32_masked(&nb_regs->global.acf_misc,
					NB_V1_V2_GLOBAL_ACF_MISC_WRSPLT_ALPINE_M0_MODE,
					NB_V1_V2_GLOBAL_ACF_MISC_WRSPLT_ALPINE_M0_MODE);
		...
		enum al_sys_fabric_wr_split_mode	*mode)
{
	...
	if (handle->ver == NB_NB_VERSION_VERSION_RELEASE_NUM_MAJOR_VAL_ALPINE_V2) {
		...
		if ((acf_misc & NB_V1_V2_GLOBAL_ACF_MISC_WRSPLT_ALPINE_M0_MODE) &&
				(sb_mstr_force_same_id_sel_0 ==
						SB_MSTR_FORCE_SAME_ID_SEL_0_VAL_ORDERED) &&
				(sb_mstr_force_same_id_sel_1 ==
						SB_MSTR_FORCE_SAME_ID_SEL_1_VAL_ORDERED)) {
			*mode = SYS_FABRIC_WR_SPLIT_MODE_ALPINE_V1;
		} else if (!(acf_misc & NB_V1_V2_GLOBAL_ACF_MISC_WRSPLT_ALPINE_M0_MODE) &&
				(sb_mstr_force_same_id_sel_0 ==
						SB_MSTR_FORCE_SAME_ID_SEL_0_VAL_NOT_ORDERED) &&
				(sb_mstr_force_same_id_sel_1 ==
						SB_MSTR_FORCE_SAME_ID_SEL_1_VAL_NOT_ORDERED)) {
	...
	const struct al_sys_fabric_qos_cfg	*cfg)
{
	...
	al_reg_write32_masked(&nb_regs->global.qos_set_control,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_ARQOS_MASK |
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_ARQOS_MASK |
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_AWQOS_MASK |
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_AWQOS_MASK |
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_ARQOS_MASK |
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_AWQOS_MASK,
		(cfg->cpu_lp_arqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_ARQOS_SHIFT) |
		(cfg->cpu_hp_arqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_ARQOS_SHIFT) |
		(cfg->cpu_lp_awqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_AWQOS_SHIFT) |
		(cfg->cpu_hp_awqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_AWQOS_SHIFT) |
		(cfg->sb_lp_arqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_ARQOS_SHIFT) |
		(cfg->sb_lp_awqos << NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_AWQOS_SHIFT));
}
	...
	struct al_sys_fabric_qos_cfg		*cfg)
{
	...
	cfg->cpu_lp_arqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_ARQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_ARQOS_SHIFT);
	cfg->cpu_hp_arqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_ARQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_ARQOS_SHIFT);
	cfg->cpu_lp_awqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_AWQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_LP_AWQOS_SHIFT);
	cfg->cpu_hp_awqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_AWQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_CPU_HP_AWQOS_SHIFT);
	cfg->sb_lp_arqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_ARQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_ARQOS_SHIFT);
	cfg->sb_lp_awqos = AL_REG_FIELD_GET(reg_val,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_AWQOS_MASK,
		NB_V1_V2_GLOBAL_QOS_SET_CONTROL_SB_LP_AWQOS_SHIFT);
}
	...
	al_bool					en)
{
	...
	al_reg_write32_masked(&nb_regs->global.acf_misc,
		NB_V1_V2_GLOBAL_ACF_MISC_SB2SB_PATH_DIS,
		en ? 0 : NB_V1_V2_GLOBAL_ACF_MISC_SB2SB_PATH_DIS);
}
