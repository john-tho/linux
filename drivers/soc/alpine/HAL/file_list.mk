...
# Chip versions
AL_DEV_ID_ALPINE_V1=0
AL_DEV_ID_ALPINE_V2=1
AL_DEV_ID_ALPINE_V3=2
AL_DEV_ID_ALPINE_V4=3

# Defines to be used with compile command
HAL_DEFINES = \
	-DAL_HAL_VER_MAJ=$(AL_HAL_VER_MAJ) \
	-DAL_HAL_VER_MIN=$(AL_HAL_VER_MIN) \
	-DAL_HAL_VER_FIX=$(AL_HAL_VER_FIX) \
	-DAL_DEV_ID_ALPINE_V1=$(AL_DEV_ID_ALPINE_V1) \
	-DAL_DEV_ID_ALPINE_V2=$(AL_DEV_ID_ALPINE_V2) \
	-DAL_DEV_ID_ALPINE_V3=$(AL_DEV_ID_ALPINE_V3) \
	-DAL_DEV_ID_ALPINE_V4=$(AL_DEV_ID_ALPINE_V4) \

#sources of the HAL drivers
HAL_DRIVER_SOURCES = \
	$(HAL_TOP)/drivers/cell/al_hal_cell_table.c \
	...
	$(HAL_TOP)/pcie/src/al_hal_pcie.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev1.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev2.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev3.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev4.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev5.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_interrupts.c \
	...
	$(HAL_TOP)/pbs/src/al_hal_pbs_utils.c \
	$(HAL_TOP)/pbs/src/al_hal_muio_mux.c \
	$(HAL_TOP)/pbs/src/al_hal_spi.c \
	$(HAL_TOP)/pbs/src/al_hal_nand.c \
	$(HAL_TOP)/pbs/src/al_hal_nand_dma.c \
	$(HAL_TOP)/pbs/src/al_hal_bootstrap.c \
	$(HAL_TOP)/pbs/src/al_hal_gpio.c \
	$(HAL_TOP)/pbs/src/al_hal_sgpo.c \
	$(HAL_TOP)/pbs/src/al_hal_i2c.c \
	$(HAL_TOP)/pbs/src/al_hal_uart.c \
	$(HAL_TOP)/pbs/src/al_hal_addr_map.c \
	$(HAL_TOP)/pbs/src/al_hal_sbus.c \
	...
	$(HAL_TOP)/drivers/axi/al_hal_axi_bw_throttling.c \
...
HAL_INIT_SOURCES_GENERIC = \
	...
	$(HAL_TOP)/services/err_events/al_err_events_pmdt.c \
	...
	$(HAL_TOP)/services/live_update/al_hal_live_update.c \
	$(HAL_TOP)/services/eth/al_eth_v3_lm_live_update.c \
	$(HAL_TOP)/services/eth/al_eth_v4_lm_live_update.c \
	$(HAL_TOP)/services/pmdt/al_pmdt.c \
	$(HAL_TOP)/services/pmdt/al_pmdt_config.c \
	$(HAL_TOP)/services/sram_agent/al_sram_agent.c \
...
HAL_INIT_INCLUDE_PATH = \
	...
	-I$(HAL_TOP)/services/live_update/ \
	-I$(HAL_TOP)/services/pmdt/ \
	-I$(HAL_TOP)/services/sram_agent/ \

#pcie sources for K2
HAL_PCIE_DRIVER_SOURCES = \
	$(HAL_TOP)/pcie/src/al_hal_pcie.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev1.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev2.c \
	$(HAL_TOP)/pcie/src/al_hal_pcie_reg_ptr_set_rev3.c \
...
HAL_PLATFORM_SOURCES_ALPINE_V1 = \
	$(HAL_TOP)/platform/alpine_v1/src/pmdt/al_hal_pmdt_map.c \

HAL_PLATFORM_INCLUDE_PATH_ALPINE_V2 = \
	-I$(HAL_TOP)/platform/alpine_v2/include

HAL_PLATFORM_SOURCES_ALPINE_V2 = \
	$(HAL_TOP)/platform/alpine_v2/src/pmdt/al_hal_pmdt_map.c \
...
HAL_PLATFORM_DRIVER_SOURCES_IOMAP_DYNAMIC_SERVICES = \
	$(HAL_TOP)/services/iomap_dynamic/al_hal_iomap_dynamic.c \

HAL_PLATFORM_SOURCES_PBS_UTILS = \
	$(HAL_TOP)/pbs/src/al_hal_pbs_utils.c \

HAL_PLATFORM_DRIVER_SOURCES_ALPINE_V1 = \
	$(HAL_TOP)/platform/alpine_v1/src/iomap_dynamic/al_hal_iomap_dynamic.c \

HAL_PLATFORM_DRIVER_SOURCES_ALPINE_V2 = \
	$(HAL_TOP)/platform/alpine_v2/src/iomap_dynamic/al_hal_iomap_dynamic.c \

HAL_PLATFORM_DRIVER_SOURCES_ALPINE_V3 = \
	$(HAL_TOP)/platform/alpine_v3/src/iomap_dynamic/al_hal_iomap_dynamic.c \

HAL_PLATFORM_DRIVER_SOURCES_ALPINE_V4 = \
