...
./reg_xref.pl include/sys_fabric/al_hal_nb_regs.h al_nb_regs nb_service > ${tmp_output}
...
cpp pcie/src/al_hal_pcie_regs.h $INCLUDES | sed "s/^#.*//g" >> $OUTPUT_DIR/pcie_regs.h
