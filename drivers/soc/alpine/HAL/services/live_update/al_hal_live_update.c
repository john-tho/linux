...
int al_lu_packed_convert(void *packed,
			enum al_lu_hal_packed_ver hal_dst_ver,
			struct al_lu_ver_to_func_tuple *convert_up_funcs,
			struct al_lu_ver_to_func_tuple *convert_down_funcs,
			enum al_lu_hal_packed_ver get_ver_func(void *packed),
...

{
	...
	al_assert(hal_dst_ver != AL_LU_HAL_VERSION_INVALID);
