...
/**
 * This function returns electric current and voltage from telemetry shared data
 * viable for V3 forward
 * @param handle uc_shared handle
 * @param channel_idx index of shunt / bus elements
 * @param electric_current pointer to store the current data
 * @param electric_voltage pointer to store the voltage data
 * @return none
 */
