...
struct al_serdes_adv_tx_params_packed_v0 {
	int	override;
	uint8_t	amp;
...
struct al_serdes_adv_rx_params_packed_v0 {
	int	override;
	uint8_t	dcgain;
...
struct al_eth_an_adv_packed_v0 {
...
struct al_eth_lm_step_data_packed_v0 {
	int		detection_state;
	int		establish_state;
	int		rx_adap_state;
	int		slc_state;
...
struct al_eth_lm_retimer_channel_status_packed_v0 {
	int	signal_detect;
	int	cdr_lock;
	int	first_check;
} __packed;

struct al_hal_eth_lm_v3_packed_v0 {
	int				lane; /* enum al_serdes_lane */
	uint32_t			link_training_failures;
	int				tx_param_dirty;
	int				serdes_tx_params_valid;
	struct al_serdes_adv_tx_params_packed_v0	tx_params_override;
	int				rx_param_dirty;
	int				serdes_rx_params_valid;
	struct al_serdes_adv_rx_params_packed_v0	rx_params_override;
	struct al_eth_an_adv_packed_v0	local_adv;
	struct al_eth_an_adv_packed_v0	partner_adv;
	int				mode; /* enum al_eth_lm_link_mode */
	uint8_t				da_len;
	int				debug;
	int				sfp_detection;
	uint8_t				sfp_bus_id;
	uint8_t				sfp_i2c_addr;
	int				default_mode; /* enum al_eth_lm_link_mode */
	uint8_t				default_dac_len;
	int				link_training;
	int				rx_equal;
	int				static_values;
	int				retimer_channel; /* enum al_eth_retimer_channel */
	int				auto_fec_enable;
	unsigned int			auto_fec_initial_timeout;
	unsigned int			auto_fec_toggle_timeout;
	uint32_t			gpio_present;
	int				retimer_tx_channel; /* enum al_eth_retimer_channel */
	int				retimer_configured;
	int				max_speed; /* enum al_eth_lm_max_speed */
	int				sfp_detect_force_mode;
	int				speed_detection;
	int				link_state; /* enum al_eth_lm_link_state */
	int				auto_fec_state; /* enum al_auto_fec_state */
	unsigned int			fec_state_last_time_toggled;
	unsigned int			auto_fec_wait_to_toggle;
	int				link_prev_up;
	int				last_detected_mode; /* enum al_eth_lm_link_mode */
	int				speed_change;
	struct al_eth_lm_step_data_packed_v0	step_data;
	struct al_eth_lm_retimer_channel_status_packed_v0	retimer_rx_channel_last_status;
	struct al_eth_lm_retimer_channel_status_packed_v0	retimer_tx_channel_last_status;
} __packed;

struct al_hal_eth_lm_v3_packed {
	int32_t		ver; /* enum al_lu_hal_packed_ver */
	uint16_t	magic;
	uint16_t	id;
	uint16_t	idx;
	uint16_t	data_len;
 ...
 */
static struct al_lu_ver_to_func_tuple eth_lm_v3_convert_up_funcs[0] = {
};
static struct al_lu_ver_to_func_tuple eth_lm_v3_convert_down_funcs[0] = {
};

static enum al_lu_hal_packed_ver eth_lm_v3_get_ver_func(void *packed)
{
	return ((struct al_hal_eth_lm_v3_packed *)packed)->ver;
}

/* Internal structs packing/unpacking */
static void
al_serdes_adv_tx_params_pack_v0(struct al_serdes_adv_tx_params_packed_v0 *packed,
				const struct al_serdes_adv_tx_params *src)
{
...
static void
al_serdes_adv_tx_params_unpack_v0(struct al_serdes_adv_tx_params *dst,
				  const struct al_serdes_adv_tx_params_packed_v0 *packed)
{
...
static void
al_serdes_adv_rx_params_pack_v0(struct al_serdes_adv_rx_params_packed_v0 *packed,
				const struct al_serdes_adv_rx_params *src)
{
	packed->override = src->override;
...
static void
al_serdes_adv_rx_params_unpack_v0(struct al_serdes_adv_rx_params *dst,
				  const struct al_serdes_adv_rx_params_packed_v0 *packed)
{
	dst->override = !!packed->override;
...
static void
al_eth_an_adv_pack_v0(struct al_eth_an_adv_packed_v0 *packed,
		      const struct al_eth_an_adv *src)
{
...
static void
al_eth_an_adv_unpack_v0(struct al_eth_an_adv *dst,
			const struct al_eth_an_adv_packed_v0 *packed)
{
...
static void
al_eth_lm_step_data_pack_v0(struct al_eth_lm_step_data_packed_v0 *packed,
			    const struct al_eth_lm_step_data *src)
{
...
static void
al_eth_lm_step_data_unpack_v0(struct al_eth_lm_step_data *dst,
			      const struct al_eth_lm_step_data_packed_v0 *packed)
{
...
static void
al_eth_lm_retimer_channel_status_pack_v0(struct al_eth_lm_retimer_channel_status_packed_v0 *packed,
					 const struct al_eth_lm_retimer_channel_status *src)
{
...
static void
al_eth_lm_retimer_channel_status_unpack_v0(struct al_eth_lm_retimer_channel_status *dst,
					   const struct al_eth_lm_retimer_channel_status_packed_v0 *packed)
{
...
/*
 * Pack a struct al_eth_lm_context into a struct al_hal_eth_lm_v3_packed_v0
 */
static int al_eth_lm_v3_pack_v0(struct al_hal_eth_lm_v3_packed *lm_packed,
				const struct al_eth_lm_context *eth_lm)
{
	struct al_hal_eth_lm_v3_packed_v0 *packed_v0 =
		(struct al_hal_eth_lm_v3_packed_v0 *)lm_packed->packed[lm_packed->active_buff];
	...
	al_serdes_adv_tx_params_pack_v0(&packed_v0->tx_params_override,
	...
	al_serdes_adv_rx_params_pack_v0(&packed_v0->rx_params_override,
					&eth_lm->rx_params_override);

	al_eth_an_adv_pack_v0(&packed_v0->local_adv, &eth_lm->local_adv);
	al_eth_an_adv_pack_v0(&packed_v0->partner_adv, &eth_lm->partner_adv);
	...
	al_eth_lm_step_data_pack_v0(&packed_v0->step_data, &eth_lm->step_data);

	al_eth_lm_retimer_channel_status_pack_v0(&packed_v0->retimer_rx_channel_last_status,
						 &eth_lm->retimer_rx_channel_last_status);

	al_eth_lm_retimer_channel_status_pack_v0(&packed_v0->retimer_tx_channel_last_status,
...
/*
 * Unpack a V0 packed struct into a struct al_eth_lm_context
 */
static int al_eth_lm_v3_unpack_v0(struct al_eth_lm_context *eth_lm,
				  const struct al_hal_eth_lm_v3_packed *lm_packed)
{
	const struct al_hal_eth_lm_v3_packed_v0 *packed_v0 =
		(const struct al_hal_eth_lm_v3_packed_v0 *)lm_packed->packed[lm_packed->active_buff];

	al_static_assert(sizeof(struct al_hal_eth_lm_v3_packed_v0) <
	...
	al_serdes_adv_tx_params_unpack_v0(&eth_lm->tx_params_override,
	...
	al_serdes_adv_rx_params_unpack_v0(&eth_lm->rx_params_override,
					  &packed_v0->rx_params_override);

	al_eth_an_adv_unpack_v0(&eth_lm->local_adv, &packed_v0->local_adv);
	al_eth_an_adv_unpack_v0(&eth_lm->partner_adv, &packed_v0->partner_adv);
	...
	al_eth_lm_step_data_unpack_v0(&eth_lm->step_data, &packed_v0->step_data);

	al_eth_lm_retimer_channel_status_unpack_v0(&eth_lm->retimer_rx_channel_last_status,
						   &packed_v0->retimer_rx_channel_last_status);

	al_eth_lm_retimer_channel_status_unpack_v0(&eth_lm->retimer_tx_channel_last_status,
...
/*****************************API Functions  **********************************/
int al_eth_lm_v3_handle_pack(struct al_hal_eth_lm_v3_packed_container *lm_packed_cont,
			     struct al_eth_lm_context *eth_lm,
			     int idx,
			     enum al_lu_hal_packed_ver dst_ver)
{
	struct al_hal_eth_lm_v3_packed *lm_packed =
				(struct al_hal_eth_lm_v3_packed *)lm_packed_cont;

	al_static_assert(sizeof(struct al_hal_eth_lm_v3_packed_v0) <
			AL_LU_ETH_LM_V3_PACKED_DATA_LEN, "Packed v0 struct to big");
	al_static_assert(sizeof(struct al_hal_eth_lm_v3_packed_container) >=
		sizeof(struct al_hal_eth_lm_v3_packed), "Packed struct larger than container");
	al_static_assert(sizeof(struct al_hal_eth_lm_v3_packed) >=
			(AL_LU_ETH_LM_V3_PACKED_BUFFER_COUNT *
			 sizeof(struct al_hal_eth_lm_v3_packed_v0)),
			"2*Packed_v0 larger than packed");

	al_assert(dst_ver < AL_LU_HAL_VERSION_MAX);

	al_memset(lm_packed_cont, 0, sizeof(struct al_hal_eth_lm_v3_packed_container));
	...
	lm_packed->data_len = sizeof(struct al_hal_eth_lm_v3_packed_v0);

	al_eth_lm_v3_pack_v0(lm_packed, eth_lm);
...
int al_eth_lm_v3_handle_unpack(struct al_eth_lm_context *eth_lm,
			       struct al_hal_eth_lm_v3_packed_container *lm_packed_cont)
{
	struct al_hal_eth_lm_v3_packed *lm_packed =
		(struct al_hal_eth_lm_v3_packed *)lm_packed_cont;
	int rc;
	 ...
	 * convert function
	 */
	al_static_assert(AL_SRDS_LANE_0 == 0, "Enum mismatch");
	al_static_assert(AL_SRDS_LANE_1 == 1, "Enum mismatch");
	al_static_assert(AL_SRDS_LANE_2 == 2, "Enum mismatch");
	al_static_assert(AL_SRDS_LANE_3 == 3, "Enum mismatch");
	al_static_assert(AL_SRDS_NUM_LANES == 4, "Enum mismatch");
	al_static_assert(AL_SRDS_LANES_0123 == 7, "Enum mismatch");

	al_static_assert(AL_ETH_LM_MODE_DISCONNECTED == 0, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MODE_10G_OPTIC == 1, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MODE_10G_DA == 2, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MODE_1G == 3, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MODE_25G == 4, "Enum mismatch");

	al_static_assert(AL_ETH_RETIMER_CHANNEL_A == 0, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_B == 1, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_C == 2, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_D == 3, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_E == 4, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_F == 5, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_G == 6, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_H == 7, "Enum mismatch");
	al_static_assert(AL_ETH_RETIMER_CHANNEL_MAX == 8, "Enum mismatch");

	al_static_assert(AL_ETH_LM_MAX_SPEED_MAX == 0, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MAX_SPEED_25G == 1, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MAX_SPEED_10G == 2, "Enum mismatch");
	al_static_assert(AL_ETH_LM_MAX_SPEED_1G == 3, "Enum mismatch");

	al_static_assert(AL_ETH_LM_LINK_DOWN == 0, "Enum mismatch");
	al_static_assert(AL_ETH_LM_LINK_DOWN_RF == 1, "Enum mismatch");
	al_static_assert(AL_ETH_LM_LINK_UP == 2, "Enum mismatch");

	al_static_assert(AL_ETH_LM_AUTO_FEC_DISABLED == 0, "Enum mismatch");
	al_static_assert(AL_ETH_LM_AUTO_FEC_ENABLED == 1, "Enum mismatch");
	al_static_assert(AL_ETH_LM_AUTO_FEC_INIT == 2, "Enum mismatch");
	al_static_assert(AL_ETH_LM_AUTO_FEC_INIT_ENABLED == 3, "Enum mismatch");
	...
	rc = al_eth_lm_v3_unpack_v0(eth_lm, lm_packed);
	if (rc != 0) {
...
unsigned int al_eth_lm_v3_packed_idx_get(struct al_hal_eth_lm_v3_packed_container *lm_packed_cont)
{
	struct al_hal_eth_lm_v3_packed *eth_lm_packed =
		(struct al_hal_eth_lm_v3_packed *)lm_packed_cont;
