...
struct al_err_events_common_module_params {
	 ...
	 * @return none
	 */
	void (*set_cause)(struct al_err_events_field *field);
	 ...
	 * @return none
	 */
	void (*get_attrs)(const struct al_err_events_field *field,
...
/**
 * Adjust field error counter according to its ignore_count value
 *
 * @param field initialized object
 * @param count number of errors
 *
 * @return number of errors to be reported after adjustments
 */
