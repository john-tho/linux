...
#include "al_hal_nb_regs_common.h"
...
#if (AL_DEV_ID <= AL_DEV_ID_ALPINE_V2)
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_CPU_INTERRIRQ,
#endif
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
...
static const struct al_err_events_field
	al_err_events_sys_fabric_fields[AL_ERR_EVENTS_SYS_FABRIC_MAX_ERRORS] = {
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_MCTL_ECC_CORR_ERR,
		.sev = AL_ERR_EVENTS_CORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_POLLING,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_MCTL_ECC_UNCORR_ERR,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_MCTL_PARITY_ERR,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_ERR_CAUSE_SUM,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_CPU_AXIERRIRQ,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
		.print = al_err_events_common_field_print,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_SB_POS_ERR,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
	...
	},
	{
		...
		.iofic_bit = NB_V1_V2_GLOBAL_NB_INT_CAUSE_ACF_ERRORIRQ,
		.sev = AL_ERR_EVENTS_UNCORRECTABLE,
		.collect_mode = AL_ERR_EVENTS_COLLECT_INTERRUPT,
		.print = al_err_events_common_field_print,
		.collect = sys_fabric_field_nb_int_error_collect,
...
static uint32_t al_err_events_sys_fabric_get_error_bit(struct al_err_events_field *field)
{
	...
	case AL_ERR_EVENTS_SYS_FABRIC_MSIX_ERROR:
		return  NB_V1_V2_GLOBAL_ERROR_CAUSE_MSIX_ERR_INT;
	case AL_ERR_EVENTS_SYS_FABRIC_LOCAL_GIC_ERROR:
		return NB_V1_V2_GLOBAL_ERROR_CAUSE_LOCAL_GIC_ECC_FATAL;
	case  AL_ERR_EVENTS_SYS_FABRIC_DDR_ON_CHIP_PARITY_ERROR:
		return NB_V1_V2_GLOBAL_ERROR_CAUSE_DDR_CAUSE_SUM;
	default:
		return 0;
	}
}
...
int al_err_events_sys_fabric_ints_enable(struct al_err_events_sys_fabric_data *data)
{
	...
	al_sys_fabric_int_clear(&data->handle,
				~NB_V1_V2_GLOBAL_NB_INT_CAUSE_CPU_AXIERRIRQ);
				  ...
				  struct al_err_events_sys_fabric_init_params *params)
{
	...
	module_params.set_cause = al_err_events_common_field_set_cause;
	module_params.get_attrs = al_err_events_common_field_get_attrs;
