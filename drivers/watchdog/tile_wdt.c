...
static int tile_wdt_probe(struct platform_device *pdev)
{
	int res;
...
static int tile_wdt_remove(struct platform_device *pdev)
{
	int res;
	...
	misc_deregister(&tile_wdt_miscdev);
	return 0;
}
