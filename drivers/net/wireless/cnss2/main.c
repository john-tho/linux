...
unsigned long m3_dump_open_data = 0;
static void m3_dump_open_timeout_func(struct timer_list *tl)
{
	struct cnss_plat_data *plat_priv = (struct cnss_plat_data *)m3_dump_open_data;
...
unsigned long m3_dump_read_data = 0;
static void m3_dump_read_timeout_func(struct timer_list *tl)
{
	struct cnss_plat_data *plat_priv = (struct cnss_plat_data *)m3_dump_read_data;
	struct m3_dump *m3_dump_data = &plat_priv->m3_dump_data;
...
static int m3_dump_open(struct inode *inode, struct file *file)
{
	...
	m3_dump_read_data = (unsigned long)plat_priv;
				  ...
				  const char *dump_file_name)
{
	...
	m3_dump_open_data = (unsigned long)plat_priv;
