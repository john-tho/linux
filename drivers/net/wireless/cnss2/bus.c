...
unsigned long timout_hdlr_data = 0;
void cnss_bus_fw_boot_timeout_hdlr(struct timer_list *tl)
{
	struct cnss_plat_data *plat_priv = (struct cnss_plat_data *)timout_hdlr_data;
	if (!plat_priv)
		return;
