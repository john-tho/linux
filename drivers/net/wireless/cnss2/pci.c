...
__attribute__((unused)) static int cnss_pci_suspend(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
out:
 ...
 __attribute__((unused)) static int cnss_pci_resume(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
__attribute__((unused)) static int cnss_pci_suspend_noirq(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
__attribute__((unused)) static int cnss_pci_resume_noirq(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
__attribute__((unused)) static int cnss_pci_runtime_suspend(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
__attribute__((unused)) static int cnss_pci_runtime_resume(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
	int ret = 0;
	struct pci_dev *pci_dev = to_pci_dev(dev);
...
__attribute__((unused)) static int cnss_pci_runtime_idle(struct device *dev)
{
#ifdef CONFIG_PCI_SUSPENDRESUME
...
__attribute__((unused)) int cnss_pci_pm_runtime_resume(struct cnss_pci_data *pci_priv)
{
	struct pci_dev *pci_dev;
...
unsigned long rddm_timeout_data = 0;
static void cnss_dev_rddm_timeout_hdlr(struct timer_list *tl)
{
	struct cnss_pci_data *pci_priv = (struct cnss_pci_data *)rddm_timeout_data;
	struct cnss_plat_data *plat_priv = NULL;
		   ...
		   struct cnss_plat_data *plat_priv)
{
	...
	case QCA6490_DEVICE_ID:
		...
		rddm_timeout_data = (unsigned long)pci_priv;
