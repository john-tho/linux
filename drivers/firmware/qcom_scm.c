...
static const struct of_device_id qcom_scm_dt_match[] = {
	...
	{ .compatible = "qcom,scm-sdx20", .data = (void *)SCM_NOCLK },
	{ .compatible = "qcom,scm-msm8960",},
	{ .compatible = "qcom,scm-msm8960",},
	{ .compatible = "qcom,scm",},
	{}
...
{
	int ret;
extern int __qcom_scm_wcss_boot(struct device *dev, u32 svc_id, u32 cmd_id, void *cmd_buf);
...
int qcom_scm_mem_protect_ipa_region(uint32_t reg_addr, size_t reg_size)
{
	return __qcom_scm_mem_protect_ipa_region(__scm->dev, reg_addr, reg_size);
}
EXPORT_SYMBOL(qcom_scm_mem_protect_ipa_region);
