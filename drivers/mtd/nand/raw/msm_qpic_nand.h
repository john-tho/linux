...
#define MSM_NAND_DEV_CMD1_UNADJ(info)             MSM_NAND_REG(info, 0x300A4)
#define MSM_NAND_DEV_CMD_VLD_UNADJ(info)          MSM_NAND_REG(info, 0x3000AC)
