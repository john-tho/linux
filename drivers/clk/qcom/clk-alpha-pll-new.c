...
const struct clk_ops clk_alpha_pll_new_ops = {
...
const struct clk_ops clk_alpha_pll_hwfsm_new_ops = {
...
const struct clk_ops clk_alpha_pll_huayra_new_ops = {
	.enable = clk_alpha_pll_enable,
	.disable = clk_alpha_pll_disable,
	.is_enabled = clk_alpha_pll_is_enabled,
...
const struct clk_ops clk_alpha_pll_brammo_new_ops = {
	.enable = clk_alpha_pll_enable,
	.disable = clk_alpha_pll_disable,
	.is_enabled = clk_alpha_pll_is_enabled,
	.recalc_rate = clk_alpha_pll_recalc_rate,
...
const struct clk_ops clk_alpha_pll_stromer_new_ops = {
	.enable = clk_alpha_pll_enable,
	.disable = clk_alpha_pll_disable,
	.is_enabled = clk_alpha_pll_is_enabled,
...
const struct clk_ops clk_alpha_pll_postdiv_new_ops = {
...
const struct clk_ops clk_alpha_pll_postdiv_ro_new_ops = {
