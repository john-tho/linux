...
static const u8 spark_pll_regs[] = {
	[PLL_OFF_L_VAL] = 0x04,
...
static const u8 brammo_pll_regs[] = {
	[PLL_OFF_L_VAL] = 0x04,
	[PLL_OFF_ALPHA_VAL] = 0x08,
	[PLL_OFF_ALPHA_VAL_U] = 0x0c,
	[PLL_OFF_USER_CTL] = 0x10,
	...
	[PLL_OFF_CONFIG_CTL_U] = 0xff,
	[PLL_OFF_TEST_CTL] = 0x1c,
	[PLL_OFF_TEST_CTL_U] = 0xff,
	[PLL_OFF_STATUS] = 0x24,
};

static const u8 huayra_pll_regs[] = {
	[PLL_OFF_L_VAL] = 0x04,
	[PLL_OFF_ALPHA_VAL] = 0x08,
...
static int gcc_ipq807x_probe(struct platform_device *pdev)
{
	...
	/* TODO: Implement v2 SOC identification */
	...
	if (*soc_version_major != 1) {
		...
		clk_register_fixed_rate(&pdev->dev, "pcie20_phy0_pipe_clk", NULL, NULL,
                                      250000000);
	} else {
		clk_register_fixed_rate(&pdev->dev, "pcie20_phy0_pipe_clk", NULL, NULL,
                                      125000000);
