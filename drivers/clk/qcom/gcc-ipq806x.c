...
static const struct freq_tbl clk_tbl_ce5_src[] = {
	{ 150000000, P_PLL3, 8, 1, 1 },
	{ 213200000, P_PLL11, 5, 1, 1 },
	{ }
};

static struct clk_dyn_rcg ce5_core_clk_src = {
	.ns_reg[0] = 0x36c4,
	.ns_reg[1] = 0x36c8,
	.p[0] = {
		.pre_div_shift = 3,
	...
	.freq_tbl = clk_tbl_ce5_src,
	.clkr = {
		.enable_reg = 0x36c0,
		.enable_mask = BIT(1),
		.hw.init = &(struct clk_init_data){
			.name = "ce5_core_clk_src",
...
static struct clk_branch ce5_core_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "ce5_core_clk",
			.parent_names = (const char *[]){ "ce5_core_clk_src" },
			.num_parents = 1,
			.ops = &clk_branch_ops,
			.flags = CLK_SET_RATE_PARENT,
		},
...
static struct clk_branch ce5_a_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "ce5_a_clk",
			.parent_names = (const char *[]){ "ce5_a_clk_src" },
			.num_parents = 1,
			.ops = &clk_branch_ops,
			.flags = CLK_SET_RATE_PARENT,
		},
...
static struct clk_branch ce5_h_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			.name = "ce5_h_clk",
			.parent_names = (const char *[]){ "ce5_h_clk_src" },
			.num_parents = 1,
			.ops = &clk_branch_ops,
			.flags = CLK_SET_RATE_PARENT,
		},
