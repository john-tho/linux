...
#define IF_HAVE_PG_HOMECACHE(flag,string)  ,{1UL << flag, string}
#else
#define IF_HAVE_PG_HOMECACHE(flag,string)
#endif
...
IF_HAVE_PG_HOMECACHE(PG_homecache_nomigrate, "homecache_nomigrate" )
