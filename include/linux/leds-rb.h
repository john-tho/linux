...
enum pled_name {
    ...
    PLED_NAME_led_ok,
    PLED_NAME_eth_led,
    PLED_NAME_system_eth_led,
    PLED_NAME_poe_led,
    PLED_NAME_system_led,
    PLED_NAME_wps_button,
    PLED_NAME_system_wlan_led,
    PLED_NAME_lte_ant_sw1,
    PLED_NAME_lte_ant_sw2,
    PLED_NAME_fpga_reset,
    PLED_NAME_eth2_led,
    PLED_NAME_uart_select,
    PLED_NAME_ext_pin1,
    PLED_NAME_ext_pin2,
    PLED_NAME_ext_pin3,
    PLED_NAME_ext_pin4,
