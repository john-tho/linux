...
static unsigned ssr_val = -1u;
module_param(ssr_val, uint, 0);
...
static int ssr_gpio_direction_output(struct gpio_chip *chip,
				     unsigned offset, int value) {
	ssr_gpio_set(chip, offset, value);
	return 0;
}

static struct gpio_chip ssr_gpio_chip = {
	.label			= "ssr-gpio",
	.direction_output	= ssr_gpio_direction_output,
	.set			= ssr_gpio_set,
	.get			= ssr_gpio_get,
