...
#define hv_uart_ctrl _hv_uart_ctrl
#define hv_simcard_io _hv_simcard_io
#define hv_close_all_devices _hv_close_all_devices
...
HV_WRAP5(int, hv_confstr, HV_ConfstrQuery, query, HV_VirtAddr, buf, int, len,
	 long, arg0, long, arg1)
#if CHIP_HAS_IPI()
...
#endif /* !CHIP_HAS_IPI() */
HV_WRAP3(int, hv_uart_ctrl, int, idx, int, cmd, int, data);
HV_WRAP2(int, hv_simcard_io, unsigned, cmd, unsigned char *, buf);
...
HV_WRAP0(int, hv_close_all_devices)
