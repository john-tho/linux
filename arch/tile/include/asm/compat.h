...
/* Truncate and zero-extend the user pointer loading from the user's ptregs. */
static inline void __user *compat_ptr_adjust(void __user *uptr)
{
	return (void __user *)(long)(u32)(long)uptr;
}
...
static inline void __user *arch_compat_alloc_user_space(long len)
{
	...
	return compat_ptr_adjust((void __user *)(regs->sp - len));
}

extern void compat_reset_context(void);
