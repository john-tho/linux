...
#if defined(CONFIG_HVC_TILE) && defined(__tilegx__)
#define hvc_tile_quiesce()	 \
	hv_console_set_ipi(KERNEL_PL, -1, (HV_Coord) {0, 0})
#else
#define hvc_tile_quiesce()	{}
#endif
...
/* Initialize any dynamic state in the init_task structure. */
