...
#define GPO_SSD1_RST		(1ULL << 8)
#define GPO_FAULT_LED		(1ULL << 9)
#define GPI_STM8_FAN_IRQ	(1ULL << 10)
#define GPO_STM8_FAN_RST	(1ULL << 11)

#define GPI_SD_CDn		(1ULL << 52)
#define GPI_BUTTON		(1ULL << 17)
#define GPI_PIN_HOLE		(1ULL << 16)

#define CCR1036R2_MODE_BUTTON	16
#define GPI_CCR1036R2_MODE_BUTTON	(1ULL << (CCR1036R2_MODE_BUTTON))
