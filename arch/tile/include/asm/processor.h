...
#else
#define HARDWALL_TYPES 2   /* udn and ipi */
#endif
#endif
...
struct thread_struct {
	...
	/* Whether unsequestering is currently happening (recursion depth). */
	int homecache_is_unsequestering;
	...
	/* mmap() information passed down to mmap_region() with VM_DONTMERGE. */
	pid_t homecache_pid;
	u64 homecache_prot;
#endif
