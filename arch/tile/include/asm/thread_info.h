...
/* Allocate thread stacks homed on the current cpu. */
extern unsigned long *alloc_thread_stack_node(struct task_struct *task, int node);
...
#define TIF_VIRT_EXIT		12	/* force exit of task in vmresume */
#define TIF_UPROBE		13	/* breakpointed or single-stepping */
...
#define _TIF_ALLWORK_MASK \
	(_TIF_WORK_MASK | _TIF_SINGLESTEP | _TIF_NOHZ | _TIF_VIRT_EXIT | _TIF_UPROBE)

/* Work to do at syscall entry. */
#define _TIF_SYSCALL_ENTRY_WORK \
	(_TIF_SYSCALL_TRACE | _TIF_SYSCALL_TRACEPOINT |_TIF_SYSCALL_AUDIT | _TIF_NOHZ)

/* Work to do at syscall exit. */
#define _TIF_SYSCALL_EXIT_WORK					\
